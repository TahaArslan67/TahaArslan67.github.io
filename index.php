...
<head>
    ...
    <title>CEC - Giriş Ekranı</title>
    <link rel="icon" href="cecico.ico"image/x-icon" />
    <style>
        html {
            background: url(Blank-Desktop-Wallpaper.jpg) no-repeat center center fixed;
...
<body class="arkaplan" style="text-align: center;">
...
<style>
    ...
    .asd{
        background-color: rgba(123, 194, 222, 0);
        width: 400px;
        height: 60%;
...
.closebtn:hover {
    ...
    form{
        box-shadow: 0 0 2.3px rgb(255, 255, 255, 0.4);
...
<div class="alert container2 hidden">
    <span class="closebtn" onclick="fonksio1()">×</span> 

...
var oncekinitutankart = tarotkartsayisi;
...
var gizlenen7 = document.querySelector(".btn-bordered-black4");
...
var liste = [];
for(;il<7;il++){
    il = Math.trunc(Math.random()* 78)+1;
...
for(;ul<7;ul++){
    ul = Math.trunc(Math.random()* 78)+1;
...
function sonraki(){
    ...
    // oncekinitutankart = tarotkartsayisi;
...
function onceki(){
    ...
    tarotkartsayisi = oncekinitutankart;
    tarot.src= `tarot-${tarotkartsayisi}.jpg`;
...
function oncekinicagirma(){
    gizlenen7.classList.remove("hidden");
} 
